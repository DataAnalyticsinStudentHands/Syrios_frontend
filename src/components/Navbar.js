      ...
      <Navbar.Collapse id='responsive-navbar-nav'>
        <Nav className='ms-auto'  style={{marginRight:'5.2vmax'}}>
          ...
          {/* Because Nav is from Bootstrap and Link is from react!!!!!!! */}
            <Nav.Link href='/dev' className='navbar-text d-flex align-items-center'>HOME</Nav.Link>
          ...
          <NavDropdown title='EVIDENCE' className='navbar-text'>
            ...
            <NavDropdown.Item href='/dev/Evidence/Timeline' className='navbar-text'>Coins in Time</NavDropdown.Item>
