  ...
  return (
    <div>
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-5 align-self-center">
                <ParaTextLeft data-aos="fade-left">
                    A regular person working on a farm or in a shop would earn
                    around 18 of these bronze coins a day.
                </ParaTextLeft>
            </div>
        </div>
        ...
        <div className="row top-spacer-05">
            ...
            <div className="col-md-4 align-self-center">
                <SubText data-aos="fade-left">
                    “Antioch, a city known to all the world… so rich is it in
        ...
        <div className="row top-spacer-3">
            <div className="col-md-7 align-self-center">
                <Level1Text data-aos="fade-left">
                    This coin could still buy important items for a person
                    living in Antioch.
                </Level1Text>
            </div>
            <div className="col-md-1"></div>
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-6 align-self-center" data-aos="fade-in">
                <ParaText>
                    Many other cities minted their own civic coins and may have
                    refused to accept the Antiochians’ coins in the market.
                </ParaText>
            </div>
            <div className="col-md-3" data-aos="flip-left">
                ...
                <SubText>
                    This civic bronze coin was minted at Seleucia Pieria,
                    Antioch’s neighbor.
                </SubText>
            </div>
        </div>
