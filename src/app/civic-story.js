      ...
      <div className="container-fluid px-6">
        ...
        <div className="row top-buffer-2">
          ...
          <div className="col-md-4">
            ...
            <StoryTitle data-aos="slide-left">POLITICAL</StoryTitle>
        ...
        <div className="row top-spacer-3">
          ...
          <div className="col-md-8 align-self-center">
            <ParaText data-aos="fade-down">
              Antioch was one of the most important cities of the Roman empire. According to the
              ancient writers Strabo and Josephus, Antioch was the third largest city.
            </ParaText>
          </div>
          <div className="col-md-2"></div>
        </div>
        ...
        <div className="row top-spacer-3">
          ...
          <div className="col-md-6 align-self-center">
            <Captions data-aos="fade-left">
              ...
              <StyledLink
                href="https://worcester.emuseum.com/objects/27632/mosaic-of-a-funerary-symposium"
                target="_blank"
        ...
        <div className="row top-spacer-05">
          ...
          <div className="col-md-8 align-self-center" style={{ textAlign: 'center' }}>
            <img src={council} alt="Logo" data-aos="fade-in" className="img-responsive" />
          </div>
          <div className="col-md-2"></div>
        </div>
        ...
        <div className="row top-spacer-05">
          <div className="col-md-8 align-self-center" style={{ textAlign: 'center' }}>
            <img src={theatre} alt="Logo" data-aos="fade-in" className="img-responsive" />
          </div>
          <div className="col-md-4 align-self-center">
            <SubText data-aos="fade-left">
        ...
        <div className="row top-spacer-05">
          <div className="col-md-2"></div>
          <div className="col-md-8 align-self-center" style={{ textAlign: 'center' }}>
            <img src={forum} alt="Logo" data-aos="fade-in" className="img-responsive" />
          </div>
          <div className="col-md-2"></div>
        </div>
        ...
        <div className="row top-spacer-05">
          ...
          <div className="col-md-5 align-self-center" style={{ textAlign: 'center' }}>
            <img src={festival} alt="Logo" data-aos="fade-in" className="img-responsive" />
            <Captions data-aos="fade-up">
              This painting is based upon the <em>Mosaic of Bacchic Dancers</em> (2nd cent. CE),
              which was excavated at Antioch and is now at the Hatay Archaeology Museum (Antakya,
        ...
        <div className="row top-spacer-3">
          <div className="col-md-2"></div>
          <div className="col-md-8 align-self-center" style={{ textAlign: 'center' }}>
            <img src={protest} alt="Logo" data-aos="fade-in" className="img-responsive" />
          </div>
          <div className="col-md-2"></div>
        </div>
        <div className="row top-spacer-05">
        ...
        <div className="row top-spacer-05">
          <div className="col-md-1"></div>
          <div className="col-md-5 align-self-center" style={{ textAlign: 'center' }}>
            <img src={protest_2} alt="Logo" data-aos="fade-in" className="img-responsive" />
          </div>
          <div className="col-md-1"></div>
          <div className="col-md-4 align-self-center">
            <SubText data-aos="fade-left">
              “The emperor Marcus Aurelius pardoned…the Antiochians, who had said many things
        ...
        <div className="row top-spacer-05">
          <div className="col-md-1"></div>
          <div className="col-md-5 align-self-center" style={{ textAlign: 'center' }}>
            <img src={inscription} alt="Logo" data-aos="fade-in" className="img-responsive" />
          </div>
          <div className="col-md-1"></div>
          <div className="col-md-4 align-self-center">
            <SubText data-aos="fade-left">
            ...
            <ul>
              ...
              <li>
                <StyledLink
                  ...
                  rel="noopener noreferrer"
                >
                  Münzkabinet, Staatliche Museen zu Berlin, 18257614; photograph by Bernhard Weisser
                </StyledLink>
              </li>
            </ul>
          </div>
