  ...
  return (
    <>
      <div id='landing-page'>
        ...
        <Container>
          <p className='story-text text-center landing-green-paragraph'>
            ...
            We welcome your feedback as we continue to develop new content, data, and digital interfaces for the study of ancient Syria and coins.
          </p>
