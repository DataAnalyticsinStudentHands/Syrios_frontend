/**
 * TextText.jsx — Vite Migration Refactor (2026)
 *
 * Changes:
 * - `.js` → `.jsx`
...
const TextText = (props) => {
  ...
  const TextTxtBody = () => {
    if (
      (zone.tt_text_left.text === "" || zone.tt_text_left.text === null) &&
      (zone.tt_text_left.caption === "" || zone.tt_text_left.caption === null)
    ) {
      return (
      ...
      (zone.tt_text_right.text === "" || zone.tt_text_right.text === null) &&
      (zone.tt_text_right.caption === "" || zone.tt_text_right.caption === null)
    ) {
      return (
        <Row className="d-flex justify-content-around align-items-center">
          <Col xs={6}>
