    ...
    <div className="intro-page">
      <div className="class-title">
        <div className="intro-main-title">
          ...
          <h1 data-aos="fade-in" className="intro-main-title-h1">SYRIOS</h1>
          <h2 data-aos="fade-in" className="intro-main-title-h2">
            PROJECT
          </h2>
          <p className="intro-main-subtitle" data-aos="fade-in">
            Studying <span style={{color:'#2d616a'}}>Urban Relationships</span> and Identify over <span style={{color:'#2d616a'}}>Ancient Syria</span>
          </p>
          <span>
            <img src={logo} className="title-logo" data-aos="fade-in" alt="logo"/>
          </span>
        </div>
      ...
      <div className="component-mix">
          <div className="threeD-coin" data-aos="fade-in">
        ...
        <div className="component-8" data-aos="slide-up">
          <span className="align-subtitle">
            <h2>
              The citizens wanted to make sure that everyone knew that these
              coins belonged to them
            </h2>
          </span>
        </div>
        <div className="component-9" data-aos="fade-right">
          <span>
            ...
            <span className="align-subtitle-caption">
              They wrote their name on the coins in Greek: ΑΝΤΙΟΧΕΩΝ, which
              means 'Belongs to Antiochians'
            </span>
          </span>
        </div>
        ...
        <div className="component-13" data-aos="fade-right">
          <span>
            ...
            />
            <span className="align-subtitle-caption">
              People of ancient Syria used Greek letters. ΔΡ tells us the coin
              was minted in 55/56 CE, during the reign of emperor Nero.
            </span>
          </span>
        </div>
        ...
        <div className="component-19" data-aos="fade-right">
          <span>
            ...
            />
            <span className="align-subtitle-caption">
              Denomination marks are very rare for ancient Syria. Instead,
              people knew the value based upon a coin’s metal, size, and images.
            </span>
          </span>
        </div>
        <div className="component-20" data-aos="fade-right">
          <span>
            ...
            <span className="align-subtitle-caption">
              ...
              circulating coin to give it extra value or keep it working as
              money. Cities and governments could do this, but so could the
              military.
            </span>
          </span>
        </div>
        <div className="component-21">
          <span>
            ...
            <span className="align-subtitle-caption" data-aos="fade-right">
              Sometimes, a coin would be cut in half.   We aren’t quite sure
              why, but it likely was an attempt to make more coins when you
              couldn’t mint more.
            </span>
          </span>
        </div>
