    ...
    <div className="container-fluid px-6">
      ...
      <div className="row top-buffer-1">
        ...
        <div className="col-md-8">
          <PageTitleCentered>Download the Dataset</PageTitleCentered>
        </div>
        <div className="col-md-2"></div>
      </div>
      <FormContainer>
        <div className="row top-spacer-1">
          <div className="col-md-7">
            <ParaTextLeft>
              The data made available here has been compiled from the excavation of Antioch, which
              was conducted by a consortium of institutions led by Princeton University from
              1932-1939. This dataset is not of the full catalog, but the 10,110 coin finds dated
              between 330 BCE and 450 CE.
            </ParaTextLeft>
            <ParaTextLeft>
