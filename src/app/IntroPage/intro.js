            ...
            <div className="container-fluid px-6">
                ...
                <div className="row top-buffer-1">
                    ...
                    <div className="col-md-2">
                        <svg width="30" height="45" xmlns="http://www.w3.org/2000/svg" data-aos="fade-down">
                            <g>
                                <title>Layer 1</title>
                                <line id="svg_1" y2="41" x2="15" y1="0" x1="15" strokeWidth="4" stroke="#17434A"
                                      fill="none"/>
                                <line id="svg_2" y2="23.684" x2="27" y1="41" x1="14" strokeWidth="4" stroke="#17434A"
                                      fill="none"/>
                                <line id="svg_3" y2="23.684" x2="3" y1="41" x1="16" strokeWidth="4" stroke="#17434A"
                                      fill="none"/>
                            </g>
                        </svg>
                    </div>
                ...
                <div className="row top-spacer-3">
                    ...
                    <div className="col-md-4 align-self-center" data-aos="fade-in">
                        <ParaText>Some of these coins were for kings and emperors. These are like our federal
                            U.S. coins or the European Union coins.</ParaText>
                    </div>
                ...
                <div className="row top-spacer-6">
                    ...
                    <div className="col-md-4 align-self-center" data-aos="fade-in">
                        <ParaText>Other coins were for provinces or regions. This would be like if the
                            states of America minted their own coins.</ParaText>
                    </div>
                    <div className="col-md-3" data-aos="flip-left">
                        <div style={{textAlign: 'center'}}>
                            <img
                ...
                <div className="row top-spacer-6">
                    ...
                    <div className="col-md-4 align-self-center" data-aos="fade-in">
                        <ParaText>Many individual cities and peoples in Syria and the Middle East also
                            minted their own coins. This is like if New York or Chicago or Paris
                            or London minted their own coins.</ParaText>
                    </div>
                    <div className="col-md-3" data-aos="flip-left">
                        <div style={{textAlign: 'center'}}>
                            <img
                ...
                <div className="row top-spacer-4">
                    ...
                    <div className="col-md-4 align-self-center" data-aos="fade-up">
                        <ParaText>Like the dime, the little bronze coin has images and writing which form its <span
                            id="term">type</span>.</ParaText>
                    </div>
                    <div className="col-md-3" data-aos="fade-left">
                        <div style={{textAlign: 'center'}}>
                            <img
                ...
                <div className="row top-spacer-5">
                    ...
                    <div className="col-md-4 align-self-center" data-aos="fade-up">
                        <ParaText>On the front or <span id="term">obverse</span>, we see the head of an important
                            person.</ParaText>
                    </div>
                    <div className="col-md-3" data-aos="flip-left">
                        <div style={{textAlign: 'center'}}>
                ...
                <div className="row top-spacer-4">
                    ...
                    <div className="col-md-4 align-self-center" data-aos="fade-up">
                        <ParaText>On the back or <span id="term">reverse</span>, we see important symbols.</ParaText>
                    </div>
                    <div className="col-md-3" data-aos="flip-left">
                        <div style={{textAlign: 'center'}}>
                            <img
                ...
                <div className="row top-spacer-4">
                    <div className="col-md-4"></div>
                    <div className="col-md-4" data-aos="fade-up">
                        <ParaText>In addition to symbols, many coins also have <span id="term">legends </span>
                            or writing on them.</ParaText>
                    </div>
                    <div className="col-md-4"></div>
                </div>
                ...
                <div className="row top-spacer-4">
                    ...
                    <div className="col-md-4 align-self-center" data-aos="fade-up">
                        <ParaText>Sometimes the <span id="term">legend</span> tells us about the government
                            behind the minting of the coin.</ParaText>
                    </div>
                    <div className="col-md-3" data-aos="flip-left">
                        <div style={{textAlign: 'center'}}>
                            <img
                ...
                <div className="row top-spacer-4">
                    ...
                    <div className="col-md-4 align-self-center" data-aos="fade-up">
                        <ParaText>Sometimes the <span id="term">legend</span> celebrates the government
                            or community values.</ParaText>
                    </div>
                    <div className="col-md-3" data-aos="flip-left">
                        <div style={{textAlign: 'center'}}>
                            <img
                ...
                <div className="row top-spacer-6">
                    <div className="col-md-2"></div>
                    <div className="col-md-8" data-aos="fade-in">
                        <ParaText>Because of the uniqueness of each coin and the issuing authority that
                            guaranteed its value (e.g., individual cities, provinces, kingdoms,
                            imperial governments), not all coins were accepted everywhere as currency.</ParaText>
                    </div>
                    <div className="col-md-2"></div>
                </div>
                ...
                <div className="row top-spacer-1">
                    ...
                    <div className="col-md-4 align-self-center">
                        <SubText>This map shows how the coins of different authorities are believed to
                ...
                <div className="row top-spacer-6">
                    <div className="col-md-2"></div>
                    <div className="col-md-8" data-aos="fade-in">
                        <ParaText>We can use digital technologies to map where, when, and in what quantities
                            ...
                            and in their <span id="term">circulation</span> as money.</ParaText>
                    </div>
                    <div className="col-md-2"></div>
                </div>
                ...
                <div className="row top-spacer-6">
                    ...
                    <div className="col-md-4 align-self-center" data-aos="fade-in">
                        <ParaText>The <span id="term">denomination</span> of a coin means how
                            much a coin is worth as money.</ParaText>
                    </div>
                    <div className="col-md-3" data-aos="flip-left">
                        <div style={{textAlign: 'center'}}>
                            <img
                ...
                <div className="row top-spacer-6">
                    ...
                    <div className="col-md-4 align-self-center" data-aos="fade-up">
                        <ParaText><span id="term">Mint marks</span> are letters or symbols which can indicate where a
                            coin was struck.</ParaText>
                    </div>
                    <div className="col-md-3" data-aos="flip-left">
                        <img
                            src={comp_16_right}
                ...
                <div className="row top-spacer-6">
                    ...
                    <div className="col-md-8" data-aos="fade-right">
                        <ParaText>Ancient coins have so much to say, as pieces of art, as objects that
                            move, and as representatives of the people who minted and used them.
                            Are you ready to learn more?</ParaText>
                    </div>
                    <div className="col-md-2"></div>
                </div>
            ...
            <Resources>
              ...
              <div className="row top-spacer-1">
                    ...
                    <div className="col-md-5">
                        ...
                        <br></br>
                        <ul>
                            <li><a href="https://gallica.bnf.fr/ark:/12148/btv1b8507404h.r=Neron%20Neron?rk=150215;2"
                                   target="_blank" rel="noopener noreferrer">Source gallica.bnf.fr / Bibliothèque
                                nationale de France, département Monnaies, médailles et antiques, Fonds général 180 </a>
                            </li>
                            <br></br>
                            <li><a href="http://numismatics.org/collection/1944.100.75243" target="_blank"
                                   rel="noopener noreferrer">American Numismatic Society 1944.100.75243</a></li>
                            <br></br>
                            <li><a href="http://numismatics.org/collection/1944.100.39966" target="_blank"
                                   rel="noopener noreferrer">American Numismatic Society 1944.100.39966</a></li>
                            <br></br>
                            <li><a href="https://ikmk.smb.museum/object?lang=en&id=18215628" target="_blank"
                                   rel="noopener noreferrer">Münzkabinet, Staatliche Museen zu Berlin, 18215628;
                                photograph by Dirk Sonnenwald</a></li>
                            <br></br>
                            <li><a href="http://numismatics.org/collection/1937.999.318" target="_blank"
                                   rel="noopener noreferrer">American Numismatic Society 1937.999.318</a></li>
                            <br></br>
                            <li><a href="http://numismatics.org/collection/1944.100.65231" target="_blank"
                                   rel="noopener noreferrer">American Numismatic Society 1944.100.65231</a></li>
                            <br></br>
                            <li><a href="https://ikmk.smb.museum/object?id=18201044" target="_blank"
                                   rel="noopener noreferrer">Münzkabinett, Staatliche Museen zu Berlin, 18201044;
                                photograph by Reinhard Saczewski</a></li>
                            <br></br>
                            <li><a href="http://numismatics.org/collection/1996.71.3?lang=en" target="_blank"
                                   rel="noopener noreferrer">American Numismatic Society - 1996.71.3</a></li>
                            <br></br>
                            <li><a href="http://numismatics.org/collection/1999.2.2" target="_blank"
                                   rel="noopener noreferrer">American Numismatic Society - 1999.2.2</a></li>
                            <br></br>
                            <li><a href="http://numismatics.org/collection/1944.100.65544" target="_blank"
                                   rel="noopener noreferrer">American Numismatic Society - 1944.100.65544</a></li>
                        </ul>
                    ...
                    <div className="col-md-5 ">
                        ...
                        <ul>
                            ...
                            <br></br>
                            <li>Butcher, K. 2001-2002. “Small Change in Ancient Beirut: The Coin Finds from BEY 006 and
                                BEY 045: Persian, Hellenistic, Roman, and Byzantine Periods,” <em>Berytus</em> 45-46.
                            </li>
                            <br></br>
                            <li>Casey, P.J. 1986. <em>Understanding Ancient Coins</em>. Norman: University of Oklahoma
                                Press.
                            </li>
                            <br></br>
                            <li>Howgego, C. 1995. <em>Ancient History from Coins</em>. London: Routledge.</li>
                            <br></br>
                            <li>Howgego, C., Heuchert, V., and Burnett, A. (eds.) 2005. <em>Coinage and Identity in the
                                Roman Provinces</em>. Oxford University Press.
                            </li>
                            <br></br>
                            <li>Metcalf, W.E. (ed.). 2012. <em>The Oxford Handbook of Greek and Roman Coinage</em>.
                                Oxford University Press.
                            </li>
                            <br></br>
                            <li>Neumann, K. Forthcoming. <em>Antioch in Syria: A History from Coins, 300 BCE-450
                                CE</em> (Cambridge University Press).
                            </li>
                        </ul>
                    </div>
                  <div className="col-md-1"></div>
