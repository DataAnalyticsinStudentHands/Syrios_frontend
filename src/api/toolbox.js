/**
 * toolbox.js — Post Vite Updates (2026)
 *
 * Purpose:
 ...
 *    - Enables in-memory caching for stable toolbox page content
 ...
 * - Expand populate fields if nested relations are introduced
...
const toolboxRequest = {
  ...
  toolboxFindLocal: async () => {
    ...
    return axios.get(`${localStrapiURL}/api/tool-box`, {
