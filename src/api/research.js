/**
 * research.js — Post Vite Updates (2026)
 *
 * Purpose:
 ...
 *    - Enables in-memory caching for stable research page content
 ...
 * - Expand populate fields if nested media is introduced
...
const researchRequest = {
  ...
  researchFindLocal: async () => {
    ...
    return axios.get(`${localStrapiURL}/api/research-home`, {
