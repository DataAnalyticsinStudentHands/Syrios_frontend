/**
 * CoinInfoPage.jsx — Vite Migration Refactor (2026)
 *
 * Changes:
 * - `.js` → `.jsx`
 *
 * Notes:
 * - No active `process.env` usage (only inside commented code)
 * - No import fixes required
 * - Logic and structure preserved 100% (no lines removed or modified)
 */
