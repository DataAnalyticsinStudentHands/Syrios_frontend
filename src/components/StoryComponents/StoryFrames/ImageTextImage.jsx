/**
 * ImageTextImage.jsx — Vite Migration Refactor (2026)
 *
 * Changes:
 * - `.js` → `.jsx`
      ...
      {zone.head.updown_switch ? (
        <Container>
          <Row className="d-flex justify-content-between align-items-center">
            <Col>
              <ImageComponent toggleBottom={props.toggleBottom} image={zone.iti_image_left} />
            </Col>
            <Col>
              <TextComponent toggleBottom={props.toggleBottom} text={zone.iti_text_middle} />
            </Col>
            <Col>
              <ImageComponent toggleBottom={props.toggleBottom} image={zone.iti_image_right} />
            </Col>
          </Row>
