/**
 * ImageText.jsx — Vite Migration Refactor (2026)
 *
 * Changes:
 * - `.js` → `.jsx`
        ...
        <Container>
          <Row className="d-flex justify-content-between align-items-center">
            {zone.left_right_switch ? (
              <>
                <Col>
                  <TextComponent toggleBottom={props.toggleBottom} text={zone.it_text} />
                </Col>
                <Col xs={`${zone.image_grid}`}>
                  <ImageComponent toggleBottom={props.toggleBottom} image={zone.it_image} />
                </Col>
              </>
            ) : (
              <>
