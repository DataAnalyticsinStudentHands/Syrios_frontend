 ...
 * - Uses alias import "src/..." (ensure vite.config.js has resolve.alias)
 * - No React import needed (new JSX transform)
 * - Kept switch-based dynamic component rendering (min-diff)
 */
...
const StoryComponent = (zone, index, fullpageApi, state, toggleBottom) => {
  switch (zone.__component) {
    ...
    default:
      console.error(
        `Error: Unrecognized component '${zone.__component}'`
      );
      return null; // prevents React warning
  }
};
