      ...
      <div>
          ...
          <div className="row top-spacer-3">
              <div className="col-md-8 align-self-center">
                  <Level1Text data-aos="fade-left">
                      The kings of the Seleucid Empire especially thought of
                      Zeus as their special protector.
                  </Level1Text>
              </div>
              <div className="col-md-4"></div>
          </div>
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-6 align-self-center">
                  <ParaText data-aos="fade-down">
                      This is one of the reasons the kings featured Zeus on
                      their royal coins.
                  </ParaText>
              </div>
              <div className="col-md-3"></div>
          ...
          <div className="row top-spacer-05">
              ...
              <div className="col-md-4 align-self-center">
                  <SubText data-aos="fade-left">
                      In this coin, we see Zeus Nicephorus – he actually carries
                      Victory in his hand as he sits on a throne. This type was
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-6 align-self-center">
                  <ParaText data-aos="fade-down">
                      According to legend, Zeus helped King Seleucus I decide
                      where to build Antioch in 300 BCE.
                  </ParaText>
              </div>
              <div className="col-md-3"></div>
          </div>
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-6">
                  <ParaText data-aos="fade-in">
                      After establishing Antioch, the kings continued to
                      celebrate Zeus.
                  </ParaText>
              </div>
              <div className="col-md-3"></div>
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-6 align-self-center">
                  <ParaText data-aos="fade-down">
                      He contributed to the building of a temple to Zeus in
                      Athens, Greece.
                  </ParaText>
              </div>
              <div className="col-md-3"></div>
          ...
          <div className="row top-spacer-05">
              ...
              <div className="col-md-5 align-self-center">
                  <SubText data-aos="fade-right">
                      “Truly, Antiochus IV’s magnificence towards the gods is
                      evidenced by the temple to [Zeus Olympius] at Athens, the
                      only one in the whole world which begins to capture the
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-6 align-self-center">
                  <ParaText data-aos="fade-down">
                      He also promised to build another temple to Zeus – (a.k.a.
                      Jupiter) – in Antioch.
                  </ParaText>
              </div>
              <div className="col-md-3"></div>
          ...
          <div className="row top-spacer-05">
              ...
              <div className="col-md-5 align-self-center">
                  <SubText data-aos="fade-left">
                      “At Antioch he projected a magnificent temple to Jupiter
                      Capitolinus, of which not only the ceiling was to be
                      overlaid with gold, but the whole of the walls were to be
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-6 align-self-center">
                  <ParaText data-aos="fade-down">
                      We aren’t sure if he ever finished this temple – or even
                      started it – but we DO know that he added new images of
                      Zeus to the coins.
                  </ParaText>
              </div>
              <div className="col-md-3"></div>
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-4 align-self-center">
                  <ParaTextLeft data-aos="fade-left">
                      On the <span id="term">obverse</span> of this bronze coin
                      is the head of Zeus.
                  </ParaTextLeft>
              </div>
              <div className="col-md-2"></div>
          ...
          <div className="row top-spacer-05">
              ...
              <div className="col-md-4">
                  <SubText data-aos="fade-in">
                      The Homeric poems refer to Zeus as “the gatherer of
                      clouds,” “god of thunder,” and “god of lightning.”
                  </SubText>
              </div>
              <div className="col-md-4"></div>
          </div>
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-4 align-self-center">
                  <ParaTextLeft data-aos="fade-right">
                      In fact, many coins minted at Antioch feature a lightning
                      bolt to refer to Zeus. This symbol is one of Zeus’
          ...
          <div className="row top-spacer-3">
              <div className="col-md-8 align-self-center">
                  <Level1Text data-aos="fade-left">
                      But Zeus was not only a god for the kings. He was a god
                      for the people too.​
                  </Level1Text>
              </div>
              <div className="col-md-4"></div>
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-4 align-self-center" style={{textAlign: 'center'}}>
                  ...
                  />
                  <SubText data-aos="fade-in">
                      A much later silver tridrachm possibly minted at Rome for
                      Syria (c. 98 CE) features such a Zeus combined with a
                      local god.
                  </SubText>
              </div>
              <div className="col-md-1"></div>
              <div className="col-md-5 align-self-center">
                  <ParaTextLeft data-aos="fade-left">
                      The people of wider Syria sometimes identified Zeus with
                      their regional gods, like Baalshamin (‘Lord of Heaven’) or
                      Hadad (a bringer of storms).
                  </ParaTextLeft>
              </div>
              <div className="col-md-1"></div>
          </div>
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-6 align-self-center">
                  <ParaText data-aos="fade-in">
                      This is called <span id="term">syncretism</span>, where
                      belief systems are blended together.
                  </ParaText>
              </div>
              <div className="col-md-3"></div>
          </div>
          ...
          <div className="row top-spacer-3">
              <div className="col-md-8 align-self-center">
                  <Level1Text data-aos="fade-left">
                      The people of Antioch also worshipped Zeus. Our best
                      evidence comes from their civic coins.
                  </Level1Text>
              </div>
              <div className="col-md-4"></div>
          </div>
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-6">
                  <ParaText data-aos="fade-down">
                      The very first coins minted by the citizens under Seleucus
                      I feature Zeus and a lightning bolt, plus the name of the
                      Antiochians.
                  </ParaText>
              </div>
              <div className="col-md-3"></div>
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-6">
                  <ParaText data-aos="fade-down">
                      The citizens continued using Zeus on their coins, even
                      after the Seleucid kings fell and the Romans conquered Syria.
                  </ParaText>
              </div>
              <div className="col-md-3"></div>
          </div>
          ...
          <div className="row top-spacer-3">
              ...
              <div className="col-md-6 align-self-center">
                  <ParaText data-aos="fade-down">
                      There are economic reasons for continuing the same coin
                      types as the Seleucid kings, but this also reflects the
                      importance of Zeus to the citizens themselves. ​
                  </ParaText>
              </div>
              <div className="col-md-3"></div>
          </div>
