  ...
  return (
    <div>
        ...
        <div className="row top-spacer-3">
            <div className="col-md-4 align-self-center">
                <ParaText data-aos="fade-right">
                    According to the ancient historian Cassius Dio, the disaster
                    hurt visitors from all over the Mediterranean and the Middle
                    East.
                </ParaText>
            </div>
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-6">
                <ParaText data-aos="fade-down">
                    The damage was like a disaster hitting New York or London
                    during a world summit.
                </ParaText>
            </div>
            <div className="col-md-3"></div>
        </div>
        ...
        <div className="row top-spacer-3">
            <div className="col-md-8 align-self-center">
                <Level1Text data-aos="fade-left">
                    The coins excavated at Antioch can give us a sense of who
                    visited the city during the Roman period.
                </Level1Text>
            </div>
            <div className="col-md-4">
                <img
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-4 align-self-center">
                <ParaTextLeft data-aos="fade-right">
                    At Antioch, 960 total identifiable coins were excavated that
        ...
        <div className="row top-spacer-3">
            <div className="col-md-8 align-self-center">
                <Level1Text data-aos="fade-left">
                    The rest of the coins come from a scattered mix across the
        ...
        <div className="row top-spacer-05">
            ...
            <div className="col-md-6">
                <ParaText data-aos="fade-up">
                    Although we cannot be sure that people from these locations
                    were the ones who carried the coins into Antioch, their
                    spread still gives us a hint as to who might have been
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-6">
                <ParaText data-aos="fade-down">
                    Still, this isn’t quite the diversity we see at other Syrian
                    sites, such as at Dura Europos (a border city under Parthian
                    rule for much of the Roman period).
                </ParaText>
            </div>
            <div className="col-md-3"></div>
        </div>
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-6">
                <ParaText data-aos="fade-down">
                    This may be due to currency regulation at Antioch. In other
                    words, officials within the city may have regulated what
                    counted as currency within city limits.
                </ParaText>
            </div>
            <div className="col-md-3"></div>
        </div>
        ...
        <div className="row top-spacer-3">
            <div className="col-md-8 align-self-center">
                <Level1Text data-aos="fade-left">
                    Even so, the coin assemblage contains important stories
                    about the people at Antioch.
                </Level1Text>
            </div>
            <div className="col-md-4"></div>
        </div>
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-4 align-self-center" data-aos="fade-in">
                <ParaText>
                    For example, 20 coins from the Kingdom of Nabataea were
                    excavated within Antioch.
                </ParaText>
            </div>
            <div className="col-md-3" data-aos="flip-left">
                ...
                <SubText>
                    The reverse shows two cornucopiae and a legend in the local
                    language.
                </SubText>
                <div className="col-md-1"></div>
            </div>
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-6">
                <ParaText data-aos="fade-down">
                    Their coins show up even further than their kingdom,
                    testifying to the vast trade network and the many
                    interactions along it.
                </ParaText>
            </div>
            <div className="col-md-3"></div>
        </div>
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-6">
                <ParaText data-aos="fade-down">
                    And the people moving in and out of Antioch were a part of
                    this trade network.
                </ParaText>
            </div>
            <div className="col-md-3"></div>
        ...
        <div className="row top-spacer-3">
            <div className="col-md-8 align-self-center">
                <Level1Text data-aos="fade-left">
                    Perhaps the most important story lies in the 102 Roman coins
                    found in the city.
                </Level1Text>
            </div>
            <div className="col-md-4"></div>
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-8 align-self-center">
                <Level1Text data-aos="fade-left">
                    This makes sense! Like the passage from Cassius Dio showed,
                    Antioch became the focus of Roman investment as a political
                    and military center during the second century CE.
                </Level1Text>
            </div>
            <div className="col-md-4"></div>
        </div>
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-6">
                <ParaText data-aos="fade-in">
                    As more Roman officials and soldiers gathered within Antioch,
                    more Roman coins traveled along with them into the city.
                </ParaText>
            </div>
            <div className="col-md-3"></div>
        </div>
        ...
        <div className="row top-spacer-3">
            ...
            <div className="col-md-6">
                <ParaText data-aos="fade-in">
                    These coins therefore testify to the merging worlds of
                    Antioch and the Roman empire.
                </ParaText>
            </div>
            <div className="col-md-3"></div>
        </div>
