...
export const HeadComponent = (props)=>{
  return(
    <Col>
      <div dangerouslySetInnerHTML={createMarkup(props.storyMain)} className='story-h2 text-center'/>
      <div dangerouslySetInnerHTML={createMarkup(props.storyCaption)} className='story-text text-center'/>
    </Col>
  )
}
    ...
    if(text.text==""||text.text==null){
      return(
        <Container className={`${component_background[text.background_color]}`} style={{padding: '20px', paddingTop: '20px'}}>
          <Row dangerouslySetInnerHTML={createMarkup(text.caption)} className='story-text text-center'/>
        </Container>
      )
    }
      ...
      return(
        <Container className={`${component_background[text.background_color]}`} style={{padding: '20px', paddingTop: '20px'}}>
          <Row dangerouslySetInnerHTML={createMarkup(text.text)} className='story-h3-blue text-center'/>
        </Container>
      )
    }
    else{
...
export const textComponent = (props)=>{
  ...
  if(text.light_blue_background){
    ...
    if(text.text==""||text.text==null){
      ...
      return(
        <Container className='light-yellow-background' style={{padding: '20px', paddingTop: '20px'}}>
        <Row dangerouslySetInnerHTML={createMarkup(text.caption)} className='story-h3 text-center'/>
      </Container>
      )
    }
    else{
