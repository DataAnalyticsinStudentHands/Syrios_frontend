...
const CoinPile = () => {
  ...
  const GqlClient = () => {
    ...
    const [GetCoin, { data: coinData, loading: coinLoading }] = useLazyQuery(GET_COIN);
    const { coin = {} } = coinData || {};
    ...
    if (loading)
      return (
        <LoadingMask loading={true} text={'loading...'} style={{ backgroundColor: '#2d616a' }}>
          <div style={{ width: 500, height: 1000, color: 'white' }}>Loading your coins ...</div>
        </LoadingMask>
      );
    ...
    const filteredResults = data.coins.filter(
      item =>
        ...
        item.IssuingAuthority.toLowerCase().includes(Authorityfilter.toLowerCase()) &&
        ...
        <div className="row top-buffer-1">
          ...
          <div className="col-md-8">
            ...
            <ParaText>
              ...
              kings, emperors, governors, and citizens. Explore the differences in the coins by
              sorting through the pile or making selections from the drop-down menu about
               1) material,{' '}
               2) the issuing authority guaranteeing a coin’s value as money,
               3) type or design and/or 4) date of minting. At
              any point, click on an individual coin to view a full description and learn more!
            </ParaText>
            <ol>
            ...
            <div className="row">
              ...
              <div className="col-md-2">
                <Form.Group controlId="select3">
                  ...
                  <Form.Control as="select" value={Datefilter} onChange={handleDateFilterChange}>
              ...
              <div className="col-md-2 mb-auto">
                <FormButton onClick={clearFilters}>
                  Clear selections
                </FormButton>
              </div>
            </div>
        ...
        <div className="row">
          ...
          >
            <Modal.Header closeButton>
              <Modal.Title id="example-custom-modal-styling-title">Coin Information</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              {coinLoading ? (
                <LoadingMask
                ...
                >
                  <div style={{ width: 500, height: 600 }}>Loading Coin Details</div>
                </LoadingMask>
              ) : (
                <React.Fragment>
                  <PageSubTitle>{coin.Title}</PageSubTitle>
                  <div>
                    <img src={coin.obverseFile} alt="" className="modal-image"></img>
                    <img src={coin.reverseFile} alt="" className="modal-image"></img>
                  </div>
                  <ParaTextLeft>
                    Region: {coin.Region}
                  ...
                  <ParaTextLeft>
                    Type: {coin.TypeCategory}
                  </ParaTextLeft>
                  <ParaTextLeft>
                    Obverse Type: {coin.ObverseType}
                  </ParaTextLeft>
                  <ParaTextLeft>
                    Obverse Legend: {coin.ObverseLegend}
                  </ParaTextLeft>
                  <ParaTextLeft>
                    Reverse Type: {coin.ReverseType}
                  </ParaTextLeft>
                  <ParaTextLeft>
