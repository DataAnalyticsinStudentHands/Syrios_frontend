/**
 * Title.jsx — Vite Migration Refactor (2026)
 *
 * Changes:
 * - `.js` → `.jsx`
      ...
      <Container className="">
        <Row className="d-flex justify-content-center">
          <Col xs={6} className="text-center">
            <img
              src={`${baseURL}${zone.image.data.attributes.url}`}
              alt={
                zone.image.data.attributes.alternativeText == null
                  ? "image"
                  : zone.image.data.attributes.alalternativeText
              }
              style={{ width: "20vmax" }}
            />
          </Col>
        ...
        <center>
          ...
          <h3
            ...
            dangerouslySetInnerHTML={createMarkup(zone.caption)}
            className="my-5 py-3"
          />
        </center>
      </Container>
