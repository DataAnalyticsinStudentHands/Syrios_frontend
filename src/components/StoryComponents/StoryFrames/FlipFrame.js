    ...
    return(
      ...
      <Container>
        <Row style={{height:'464px'}} className="d-flex justify-content-between">
          <Col xs={3} className='light-blue-background d-flex justify-content-center align-items-center'>
              <FlipCoinImage coin = {zone.flip_coin_left}/>
          </Col>
          <Col xs={3} className="d-flex align-items-start flex-column">
            <Row className='mb-auto'>
              <div dangerouslySetInnerHTML={createMarkup(zone.text_top)} className='story-text text-center'/>
            </Row>
          ...
          <Col xs={3} className='light-blue-background d-flex justify-content-center align-items-center'>
              <FlipCoinImage coin = {zone.flip_coin_right}/>
          </Col>
        </Row>
